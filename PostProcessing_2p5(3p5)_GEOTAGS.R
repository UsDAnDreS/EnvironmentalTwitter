...
load(file="topic.dfs.geotag.full.sorted.RData")
...
# View(full.df[[1]][[1]] %>% select(text, text_with_display_links))
...
save(full.df, file="topic.dfs.geotag.full.sorted.url.unwound.RData")
